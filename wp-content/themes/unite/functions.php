...
// Set UI labels for Custom Post Type
    $labels = array(
        'name'                => _x( 'Films', 'Post Type General Name', 'twentysixteen' ),
        'singular_name'       => _x( 'Film', 'Post Type Singular Name', 'twentysixteen' ),
        'menu_name'           => __( 'Films', 'twentysixteen' ),
        'parent_item_colon'   => __( 'Parent Film', 'twentysixteen' ),
        'all_items'           => __( 'All Films', 'twentysixteen' ),
        'view_item'           => __( 'View Film', 'twentysixteen' ),
        'add_new_item'        => __( 'Add New Film', 'twentysixteen' ),
        'add_new'             => __( 'Add New', 'twentysixteen' ),
        'edit_item'           => __( 'Edit Film', 'twentysixteen' ),
        'update_item'         => __( 'Update Film', 'twentysixteen' ),
        'search_items'        => __( 'Search Film', 'twentysixteen' ),
...
// Set other options for Custom Post Type
    ...
    $args = array(
        ...
        'description'         => __( 'Film news and reviews', 'twentysixteen' ),
        'labels'              => $labels,
        // Features this CPT supports in Post Editor
        'supports'            => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields', ),
        // You can associate this CPT with a taxonomy or custom taxonomy. 
        'taxonomies'          => array( 'genres','country','actors','year' ),
